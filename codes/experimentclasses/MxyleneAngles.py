...
class MxyleneAngles(AtomicRegression):
    """
    ...
    def load_data(self, angles=False):
        ...
        filename_xyz = workingdirectory + '/untracked_data/chemistry_data/m-xylene.DFT.PBE-TS.l1t.MD.500K.01.npz'
        filename_angle_indices = workingdirectory + '/untracked_data/chemistry_data/m-xyleneindices.npy'
        filename_angles = workingdirectory + '/untracked_data/chemistry_data/m-xyleneangles.npy'
