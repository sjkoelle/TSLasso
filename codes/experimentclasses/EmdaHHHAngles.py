...
class EmdaHHHAngles(AtomicRegression):
    """
    ...
    def load_data(self, angles=False):
        ...
        filename_xyz = workingdirectory + '/untracked_data/chemistry_data/eMDA-H-H-H.npz'
        filename_angle_indices = workingdirectory + '/untracked_data/chemistry_data/eMDA-H-H-H_all2indices.npy'
        filename_angles = workingdirectory + '/untracked_data/chemistry_data/eMDA-H-H-H_all2angles.npy'
