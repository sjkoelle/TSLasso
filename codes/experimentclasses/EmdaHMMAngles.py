...
class EmdaHMMAngles(AtomicRegression):
    """
    ...
    def load_data(self, angles=False):
        ...
        filename_xyz = workingdirectory + '/untracked_data/chemistry_data/eMDA-H-Me-Me.Rusinska-Roszak-DB.DFT.PBE-TS.light.MD.500K.99k.R_E_F_D_Q.npz'
        filename_angle_indices = workingdirectory + '/untracked_data/chemistry_data/eMDA-H-Me-Me_all2indices.npy'
        filename_angles = workingdirectory + '/untracked_data/chemistry_data/eMDA-H-Me-Me_all2angles.npy'
