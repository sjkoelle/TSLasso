...
class ResorcinolAngles(AtomicRegression):
    """
    ...
    def load_data(self, angles=False):
        ...
        filename_xyz = workingdirectory + '/untracked_data/chemistry_data/resorcinol.DFT.PBE-TS.l1t.MD.500K.npz'
        filename_angle_indices = workingdirectory + '/untracked_data/chemistry_data/resorcinolindices.npy'
        filename_angles = workingdirectory + '/untracked_data/chemistry_data/resorcinolangles.npy'
