...
class HydrazobenzeneAngles(AtomicRegression):
    """
    ...
    def load_data(self, angles=False):
        ...
        filename_xyz = workingdirectory + '/untracked_data/chemistry_data/hydrazobenzene.DFT.PBE-TS.l1t.MD.500K.01.npz'
        filename_angle_indices = workingdirectory + '/untracked_data/chemistry_data/hydrazobenzene_allindices.npy'
        filename_angles = workingdirectory + '/untracked_data/chemistry_data/hydrazobenzene_allangles.npy'
