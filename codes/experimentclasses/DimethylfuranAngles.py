...
class DimethylfuranAngles(AtomicRegression):
    """
    ...
    def load_data(self, angles=False):
        ...
        filename_xyz = workingdirectory + '/untracked_data/chemistry_data/dimethylfuran.DFT.PBE-TS.light.MD.500K.01.npz'
        filename_angle_indices = workingdirectory + '/untracked_data/chemistry_data/dimethylfuranindices060519.npy'
        filename_angles = workingdirectory + '/untracked_data/chemistry_data/dimethylfuranangles060519.npy'
