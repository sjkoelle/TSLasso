...
#print(os.getcwd())
from codes.experimentclasses.HydrazobenzeneAngles import HydrazobenzeneAngles
...
pca_dat = np.load(workingdirectory + '/untracked_data/chemistry_data/hydrazobenzene_allanglespca_pca50.npy')
n = pca_dat.shape[0]
...
atoms4 = np.asarray([[11,23,22,9],[11,24,25,9],[11,23,25,9],[11,24,22,9],[12,11,23,24],[12,11,23,22],[5,9,22,25],[5,9,22,23]],dtype = int)
experiment = HydrazobenzeneAngles(dim, n, ii, jj,cores,atoms4)
...
projector  = np.load(workingdirectory + '/untracked_data/chemistry_data/hydrazobenzene_allanglespca_pca50_components.npy')
folder = workingdirectory + '/Figures/hydrazobenzene/' + now
...
src = workingdirectory + '/codes/experiments/hydrazobenzene_multirun_tangent.py'
