#!/bin/bash
#SBATCH --job-name emdahhh      # Set a name for your job. This is especially useful if you have multiple jobs queued.
...
#SBATCH -o myscript_emdahhh%j.out    # File to which STDOUT will be written
#SBATCH -e myscript_emdahhh%j.err    # File to which STDERR will be written
...
python emdahhh_multirun_tangent.py