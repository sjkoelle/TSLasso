#!/bin/bash
#SBATCH --job-name emdahmm      # Set a name for your job. This is especially useful if you have multiple jobs queued.
...
#SBATCH -o myscript_emdahmm%j.out    # File to which STDOUT will be written
#SBATCH -e myscript_emdahmm%j.err    # File to which STDERR will be written
...
python emdahmm_multirun_tangent.py