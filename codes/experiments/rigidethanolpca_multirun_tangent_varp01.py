...
diffusion_time =250 #(yuchia suggestion)
dim = 2 #manifold dimension
dimnoise = 2
cores = 3 #number of cores for parallel processing
cor = 0.0 #correlation for noise
var = 0.01 #variance scaler for noise
...
src = workingdirectory + '/codes/experiments/rigidethanolpca_multirun_tangent_varp01.py'
