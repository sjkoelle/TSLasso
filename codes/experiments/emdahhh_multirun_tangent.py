...
#print(os.getcwd())
from codes.experimentclasses.EmdaHHHAngles import EmdaHHHAngles
...
pca_dat = np.load(workingdirectory + '/untracked_data/chemistry_data/eMDA-H-H-H_all2anglespca_pca50.npy')
n = pca_dat.shape[0]
...
src = workingdirectory + '/codes/experiments/emdahhh_multirun_tangent.py'
