#!/bin/bash
#SBATCH --job-name swizz_t      # Set a name for your job. This is especially useful if you have multiple jobs queued.
...
#SBATCH -o myscript_swt%j.out    # File to which STDOUT will be written
#SBATCH -e myscript_swt%j.err    # File to which STDERR will be written
...
python swissroll_multi_moredim_tangent.py
