#!/bin/bash
#SBATCH --job-name bi_tangent      # Set a name for your job. This is especially useful if you have multiple jobs queued.
...
#SBATCH -o myscript_bipca%j.out    # File to which STDOUT will be written
#SBATCH -e myscript_bipca%j.err    # File to which STDERR will be written
...
python biphenylenediol_multirun_tangent.py