...
#print(os.getcwd())
from codes.experimentclasses.EmdaHMMAngles import EmdaHMMAngles
...
pca_dat = np.load(workingdirectory + '/untracked_data/chemistry_data/eMDA-H-Me-Me_all2anglespca_pca50.npy')
n = pca_dat.shape[0]
...
atoms4 = np.asarray([[7,6,4,0],[3,2,0,1],[3,2,0,4],[2,0,4,5],[2,0,4,6],[0,4,5,12],[12,13,14,5],[9,10,11,8],[11,8,6,7],[8,6,4,5]]
,dtype = int)
experiment = EmdaHMMAngles(dim, n, ii, jj,cores,atoms4)
...
projector  = np.load(workingdirectory + '/untracked_data/chemistry_data/eMDA-H-Me-Me_all2anglespca_pca50_components.npy')
folder = workingdirectory + '/Figures/emdahmm/' + now
...
src = workingdirectory + '/codes/experiments/emdahmm_multirun_tangent.py'
