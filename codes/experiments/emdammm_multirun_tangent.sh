#!/bin/bash
#SBATCH --job-name emdammm      # Set a name for your job. This is especially useful if you have multiple jobs queued.
...
#SBATCH -o myscript_emdammm%j.out    # File to which STDOUT will be written
#SBATCH -e myscript_emdammm%j.err    # File to which STDERR will be written
...
python emdammm_multirun_tangent.py