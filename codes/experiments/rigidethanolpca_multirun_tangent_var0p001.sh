#!/bin/bash
#SBATCH --job-name repca_rigidethanolpca_multirun_tangent_var0p001      # Set a name for your job. This is especially useful if you have multiple jobs queued.
...
#SBATCH -o myscript_rigidethanolpca_multirun_tangent_var0p001%j.out    # File to which STDOUT will be written
#SBATCH -e myscript_rigidethanolpca_multirun_tangent_var0p001%j.err    # File to which STDERR will be written
