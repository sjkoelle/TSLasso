#!/bin/bash
#SBATCH --job-name hydra_tangent      # Set a name for your job. This is especially useful if you have multiple jobs queued.
...
#SBATCH -o myscript_hydrapca%j.out    # File to which STDOUT will be written
#SBATCH -e myscript_hydrapca%j.err    # File to which STDERR will be written
...
python hydrazobenzene_multirun_tangent.py
