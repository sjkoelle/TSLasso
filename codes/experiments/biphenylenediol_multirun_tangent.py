...
#print(os.getcwd())
from codes.experimentclasses.BiphenylenediolAngles import BiphenylenediolAngles
...
atoms4 = np.asarray([[14,0,1,15],[14,0,3,4],[15,1,9,10],[9,1,15,0],[3,0,14,1],[0,15,14,1]],dtype = int)
...
experiment.Mpca = RiemannianManifold(np.load(workingdirectory + '/untracked_data/chemistry_data/BIPHENYLENEDIOLanglespca_pca50.npy'), dim)
projector  = np.load(workingdirectory + '/untracked_data/chemistry_data/BIPHENYLENEDIOLanglespca_pca50_components.npy')
...
src = workingdirectory + '/codes/experiments/biph_multirun_tangent.py'
