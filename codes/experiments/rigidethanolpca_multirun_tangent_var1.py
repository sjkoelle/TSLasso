...
var = 100 #variance scaler for noise
...
noise = True
experiment = RigidEthanolPCA(dim, cor,var,ii,jj, cores, noise, atoms4)
experiment.M, experiment.Mpca,projector  = experiment.generate_data(noise = noise)
...
src = workingdirectory + '/codes/experiments/rigidethanolpca_multirun_tangent_var1.py'
