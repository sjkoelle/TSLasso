#!/bin/bash
#SBATCH --job-name repca_varnoise10      # Set a name for your job. This is especially useful if you have multiple jobs queued.
...
#SBATCH -o myscript_repcavarnoise10%j.out    # File to which STDOUT will be written
#SBATCH -e myscript_repcavarnoise10%j.err    # File to which STDERR will be written
...
python rigidethanolpca_multirun_tangent_var10.py
