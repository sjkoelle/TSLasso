#!/bin/bash
#SBATCH --job-name resorcinol_tangent      # Set a name for your job. This is especially useful if you have multiple jobs queued.
...
#SBATCH -o myscript_resorcinol%j.out    # File to which STDOUT will be written
#SBATCH -e myscript_resorcinol%j.err    # File to which STDERR will be written
...
python resorcinol_multirun_tangent.py