...
#print(os.getcwd())
from codes.experimentclasses.EmdaMMMAngles import EmdaMMMAngles
...
pca_dat = np.load(workingdirectory + '/untracked_data/chemistry_data/eMDA-Me-Me-Me_all2anglespca_pca50.npy')
n = pca_dat.shape[0]
print(n)
...
atoms4 = np.asarray([[12,14,13,8],[10,11,9,1],[3,2,0,1],[2,0,1,9],[2,0,4,5],[7,6,4,5],[6,4,5,15],[0,4,5,15],[7,6,8,12],[17,16,15,5]],dtype = int)
print('parameters loaded')
experiment = EmdaMMMAngles(dim, n, ii, jj,cores,atoms4)
...
projector  = np.load(workingdirectory + '/untracked_data/chemistry_data/eMDA-Me-Me-Me_all2anglespca_pca50_components.npy')
folder = workingdirectory + '/Figures/emdammm/' + now
...
experiment.N.plot([0,2], list(range(n)),experiment.g0,.1,1, folder + '/g1_02')
experiment.N.plot([0,3], list(range(n)),experiment.g0,.1,1, folder + '/g1_03')
...
src = workingdirectory + '/codes/experiments/emdammm_multirun_tangent.py'
