...
#print(os.getcwd())
from codes.experimentclasses.EmdaMHMAngles import EmdaMHMAngles
...
pca_dat = np.load(workingdirectory + '/untracked_data/chemistry_data/eMDA-Me-H-Me_all2anglespca_pca50.npy')
n = pca_dat.shape[0]
...
atoms4 = np.asarray([[12,14,13,8],[10,11,9,1],[3,2,0,1],[2,0,1,9],[2,0,4,5],[7,6,4,5],[7,6,8,12]],dtype = int)
experiment = EmdaMHMAngles(dim, n, ii, jj,cores,atoms4)
...
projector  = np.load(workingdirectory + '/untracked_data/chemistry_data/eMDA-Me-H-Me_all2anglespca_pca50_components.npy')
folder = workingdirectory + '/Figures/emdamhm/' + now
...
src = workingdirectory + '/codes/experiments/emdamhm_multirun_tangent.py'
