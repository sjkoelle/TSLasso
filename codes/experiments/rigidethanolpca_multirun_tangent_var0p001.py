...
var = 0.001 #variance scaler for noise
ii = np.asarray([0,0,0,0,1,1,1,2]) # atom adjacencies for dihedral angle computation
jj = np.asarray([1,2,3,4,5,6,7,8])

#run experiment
atoms4 = np.asarray([[6,1,0,4],[4,0,2,8],[7,6,5,1],[3,0,2,4]],dtype = int)
experiment = RigidEthanolPCA(dim, cor,var,ii,jj, cores, True, atoms4)
...
gnames = np.asarray([r"$\displaystyle f_1$",
	r"$\displaystyle f_2$",
	r"$\displaystyle f_3$",
	r"$\displaystyle f_4$"])
...
src = workingdirectory + '/codes/experiments/rigidethanolpca_multirun_tangent_var0p001.py'
